...
type Single struct {
	...
	GrainId        string `protobuf:"bytes,3,opt,name=grain_id,json=grainId,proto3" json:"grain_id,omitempty"`
}

func (x *Single) Reset() {
	*x = Single{}
	if protoimpl.UnsafeEnabled {
		mi := &file_flour_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Single) Descriptor() ([]byte, []int) {
	return file_flour_proto_rawDescGZIP(), []int{2}
}
...
var file_flour_proto_rawDesc = []byte{
	...
	0x65, 0x74, 0x6d, 0x61, 0x72, 0x6b, 0x73, 0x5f, 0x66, 0x6c, 0x6f, 0x75, 0x72, 0x22, 0x4a, 0x0a,
	...
	0x5f, 0x73, 0x69, 0x7a, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0c, 0x72, 0x65, 0x73,
	...
	0x32, 0x16, 0x2e, 0x6e, 0x65, 0x74, 0x6d, 0x61, 0x72, 0x6b, 0x73, 0x5f, 0x66, 0x6c, 0x6f, 0x75,
	0x72, 0x2e, 0x53, 0x69, 0x6e, 0x67, 0x6c, 0x65, 0x52, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x22,
	0x5c, 0x0a, 0x06, 0x53, 0x69, 0x6e, 0x67, 0x6c, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18,
	...
	,
...
var file_flour_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_flour_proto_goTypes = []interface{}{
	(*Request)(nil),  // 0: netmarks_flour.Request
	(*Response)(nil), // 1: netmarks_flour.Response
	(*Single)(nil),   // 2: netmarks_flour.Single
}
var file_flour_proto_depIdxs = []int32{
	2, // 0: netmarks_flour.Response.items:type_name -> netmarks_flour.Single
	0, // 1: netmarks_flour.Flour.Produce:input_type -> netmarks_flour.Request
	1, // 2: netmarks_flour.Flour.Produce:output_type -> netmarks_flour.Response
...
func file_flour_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_flour_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Single); i {
			case 0:
				return &v.state
			case 1:
